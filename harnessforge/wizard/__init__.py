"""HarnessForge wizard (Slice 7) — a generator-side single-page form for specs.

Opt-in via the ``harnessforge[wizard]`` extra (FastAPI + uvicorn). It collects a
full :class:`~harnessforge.spec.HarnessSpec` (grouped by function, language-first
