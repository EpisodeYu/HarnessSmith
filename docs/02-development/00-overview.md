...
| **v1+** | [`14-forge-add-incremental-regeneration.md`](./14-forge-add-incremental-regeneration.md)、[`15-llm-robustness-and-context.md`](./15-llm-robustness-and-context.md) | `forge add` 增量再生成 / eval harness / 更多 preset / RAG / 联网 MCP registry / 发布拓扑隔离 等 |
